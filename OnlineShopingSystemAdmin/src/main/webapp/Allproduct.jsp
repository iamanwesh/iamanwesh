...
<body>
  <!-- Topbar Start -->
    ...
    <!-- Navbar End -->
<h3 align="center" Style="border:1px solid black;margin:30px;" class="nav-item nav-link">All Product</h3>
    <!-- Shop Start -->
        ...
        <div class="row px-xl-5">
               ...
               <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-1 border border-top-1 border-bottom-1" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        ...
                        <a href="MansCollection.jsp" class="nav-item nav-link">Men's dresses</a>
                        <a href="WomansCollection.jsp" class="nav-item nav-link">Women's dresses</a>
                        <a href="KidsCollection.jsp" class="nav-item nav-link">Kid's dresses</a>
